...
defmodule OpenRoad.IntersectionTest do
  ...
  test "add_road/3 adds a road to the intersection" do
    OpenRoad.Intersection.start_link(:menaul_wyoming, [["menaul_southbound"]], TestWarden)
  ...
  test "add_road/3 returns an error if intersection specification is ambiguous" do
    OpenRoad.Intersection.start_link(:menaul_wyoming, [["menaul_southbound", "spain"], ["menaul_southbound", "wyoming"]], TestWarden)
  ...
  test "add_road/2 adds the road and builds an intersection entry" do
    OpenRoad.Intersection.start_link(:menaul_wyoming, [], TestWarden)
  ...
  test "add_road/3 doesn't change nodes that don't match target" do
    OpenRoad.Intersection.start_link(:menaul_wyoming, [["menaul_southbound"], ["wyoming_northbound", "wyoming_southbound"]], TestWarden)
